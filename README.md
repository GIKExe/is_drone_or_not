...
-----------------------------------------------------------------------
09/07 была показана работа модели v0.2b.pt
Для корректной работы модели необходимо изменить значения переменных VMIN_DB и VMAX_DB (51-52 стр.) в файле spectrogram.py на:
VMIN_DB = -84.05
VMAX_DB = 14.66
